...
DYNAMIC_QMAKE="$HOME/Qt/5.5/gcc_64/bin/qmake"
STATIC_QMAKE="$HOME/Desktop/qt/build/5.5.1/qtbase/bin/qmake"
...
# Zip static Bandage
STATIC_ZIP="Bandage_Ubuntu_static_v$VERSION.zip"
zip -j $STATIC_ZIP Bandage-static/Bandage
zip $STATIC_ZIP sample_LastGraph
rm -rf Bandage-static/

# Zip dynamic Bandage
DYNAMIC_ZIP="Bandage_Ubuntu_dynamic_v$VERSION.zip"
